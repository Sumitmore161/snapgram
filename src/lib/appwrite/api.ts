...
export async function savePost(userId: string, postId: string) {
  console.log(userId,postId,"in api.ts")  
  try {
    ...
    // console.log("just before return",savedPost);
...
export async function deleteSavePost(saveId: string) {
  console.log("this is function in deleteSavePost : ",saveId)
  try {
    const statusCode = await databases.deleteDocument(
      appwriteConfig.databaseId,
      appwriteConfig.saveCollectionId,
...
export async function getSavedPosts(userId: string) {
  try {
    ...
    console.log("this should be executed it is important: ",saved);
